        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-3">
              <span className="text-[#7F77DD] font-bold">1.</span>
              What we use
            </h2>
            <p className="text-sm text-zinc-400 leading-[1.8]">
              Versera uses <strong className="text-zinc-300">localStorage</strong> (a browser storage mechanism) to manage your session — specifically your authentication token and basic user information. This keeps you logged in between visits.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-3">
              <span className="text-[#7F77DD] font-bold">2.</span>
              No tracking cookies
            </h2>
            <p className="text-sm text-zinc-400 leading-[1.8]">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-3">
              <span className="text-[#7F77DD] font-bold">3.</span>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-3">
              <span className="text-[#7F77DD] font-bold">4.</span>
              Contact
            </h2>
            <p className="text-sm text-zinc-400 leading-[1.8]">
